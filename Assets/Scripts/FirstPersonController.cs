...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            else if (TerrainGenerator.InitialMapLoaded)
            {
        ...
        private void ProgressStepCycle(float speed)
        {
            ...
            {
                m_StepCycle += (m_CharacterController.velocity.magnitude + (speed*(m_IsRunning ? 1f : m_RunstepLenghten)))*
                             Time.fixedDeltaTime;
            }
            ...
            if (m_CharacterController.velocity.magnitude > 0 && m_CharacterController.isGrounded)
            {
                m_Camera.transform.localPosition =
                    m_HeadBob.DoHeadBob(m_CharacterController.velocity.magnitude +
                                      (speed*(m_IsRunning ? 1f : m_RunstepLenghten)));
        ...
        private void GetInput(out float speed)
        {
            ...
            if (m_IsRunning != waswalking && m_UseFovKick && m_CharacterController.velocity.sqrMagnitude > 0)
            {
                StopAllCoroutines();
                StartCoroutine(!m_IsRunning ? m_FovKick.FOVKickUp() : m_FovKick.FOVKickDown());
            }
        }
